...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> ProvasGeralBinomios / Edit #{{$provas_geral_binomio->id}}</h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('provas_geral_binomios.update', $provas_geral_binomio->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('idprovabinomio')) has-error @endif">
                    ...
                    <textarea class="form-control" id="observacoes-field" rows="3" name="observacoes">{{ $provas_geral_binomio->observacoes }}</textarea>
