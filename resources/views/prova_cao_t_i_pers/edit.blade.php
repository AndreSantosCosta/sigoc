...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> ProvaCaoTIPers / Edit #{{$prova_cao_t_i_per->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('prova_cao_t_i_pers.update', $prova_cao_t_i_per->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('idprovacao')) has-error @endif">
                    ...
                    <input type="text" id="idprovacao-field" name="idprovacao" class="form-control" value="{{ $prova_cao_t_i_per->idprovacao }}"/>
                    ...
                    <input type="text" id="data_nascim-field" name="data_nascim" class="form-control" value="{{ $prova_cao_t_i_per->data_nascim }}"/>
                    ...
                    <input type="text" id="avaliador-field" name="avaliador" class="form-control" value="{{ $prova_cao_t_i_per->avaliador }}"/>
                    ...
                    <input type="text" id="executante-field" name="executante" class="form-control" value="{{ $prova_cao_t_i_per->executante }}"/>
                    ...
                    <textarea class="form-control" id="local-field" rows="3" name="local">{{ $prova_cao_t_i_per->local }}</textarea>
                       @if($errors->has("local"))
                    ...
                    <input type="text" id="seguimento-field" name="seguimento" class="form-control" value="{{ $prova_cao_t_i_per->seguimento }}"/>
                    ...
                    <input type="text" id="levantar-field" name="levantar" class="form-control" value="{{ $prova_cao_t_i_per->levantar }}"/>
                    ...
                    <input type="text" id="submissao-field" name="submissao" class="form-control" value="{{ $prova_cao_t_i_per->submissao }}"/>
                    ...
                    <input type="text" id="chamada-field" name="chamada" class="form-control" value="{{ $prova_cao_t_i_per->chamada }}"/>
                    ...
                    <input type="text" id="buscaobj-field" name="buscaobj" class="form-control" value="{{ $prova_cao_t_i_per->buscaobj }}"/>
                    ...
                    <input type="text" id="jornal-field" name="jornal" class="form-control" value="{{ $prova_cao_t_i_per->jornal }}"/>
                    ...
                    <input type="text" id="chapeu-field" name="chapeu" class="form-control" value="{{ $prova_cao_t_i_per->chapeu }}"/>
                    ...
                    <input type="text" id="mesa-field" name="mesa" class="form-control" value="{{ $prova_cao_t_i_per->mesa }}"/>
                       @if($errors->has("mesa"))
                    ...
                    <input type="text" id="dor-field" name="dor" class="form-control" value="{{ $prova_cao_t_i_per->dor }}"/>
                       @if($errors->has("dor"))
                    ...
                    <input type="text" id="notafinal-field" name="notafinal" class="form-control" value="{{ $prova_cao_t_i_per->notafinal }}"/>
                    ...
                    <textarea class="form-control" id="observacoes-field" rows="3" name="observacoes">{{ $prova_cao_t_i_per->observacoes }}</textarea>
                    ...
                    <textarea class="form-control" id="arquivo-field" rows="3" name="arquivo">{{ $prova_cao_t_i_per->arquivo }}</textarea>
