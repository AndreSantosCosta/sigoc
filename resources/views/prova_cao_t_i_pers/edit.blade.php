        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('prova_cao_t_i_pers.update', $prova_cao_t_i_per->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('data_nascim')) has-error @endif">
                    ...
                    <input type="text" id="local-field" name="local" class="form-control" value="{{ $prova_cao_t_i_per->local }}"/>
                       @if($errors->has("local"))
                    ...
                    <input type="text" id="arquivo-field" name="arquivo" class="form-control" value="{{ $prova_cao_t_i_per->arquivo }}"/>
