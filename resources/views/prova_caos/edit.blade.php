...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> ProvaCaos / Edit #{{$prova_cao->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('prova_caos.update', $prova_cao->id) }}" method="POST">
                <input type="hidden" name="_method" value="PUT">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">

                <div class="form-group @if($errors->has('prova_id')) has-error @endif">
                       <label for="prova_id-field">Prova_id</label>
                    <input type="text" id="prova_id-field" name="prova_id" class="form-control" value="{{ $prova_cao->prova_id }}"/>
                    ...
                    <input type="text" id="cao_id-field" name="cao_id" class="form-control" value="{{ $prova_cao->cao_id }}"/>
                    ...
                    <input type="text" id="tipoprova-field" name="tipoprova" class="form-control" value="{{ $prova_cao->tipoprova }}"/>
                    ...
                    <input type="text" id="dataprova-field" name="dataprova" class="form-control" value="{{ $prova_cao->dataprova }}"/>
