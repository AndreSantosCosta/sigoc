        ...
        <?php if (User::tipoUserLogado()=='A') {?>
            <form action="{{ route('prova_cao_t_a_n_a_t1s.destroy', $prova_cao_t_a_n_a_t1->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Delete? Are you sure?')) { return true } else {return false };">
                ...
                <div class="btn-group pull-right" role="group" aria-label="...">
                    <a class="btn btn-warning btn-group" role="group" href="{{ route('prova_cao_t_a_n_a_t1s.edit', $prova_cao_t_a_n_a_t1->id) }}"><i class="glyphicon glyphicon-edit"></i> Editar</a>
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <a class="btn btn-link" href="{{ route('prova_cao_t_a_n_a_t1s.index') }}"><i class="glyphicon glyphicon-backward"></i>  Voltar</a>
