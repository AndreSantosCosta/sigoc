        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('binomios.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('data_inicio')) has-error @endif">
                    ...
                    <input type="text" id="num_mecanografico_id-field" name="num_mecanografico_id" class="form-control" value="{{ old("num_mecanografico_id") }}"/>
                    ...
                    <input type="text" id="num_matricula_id-field" name="num_matricula_id" class="form-control" value="{{ old("num_matricula_id") }}"/>
