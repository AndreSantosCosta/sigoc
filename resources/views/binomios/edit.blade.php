  ...
  <div class="col-md-12">
   ...
   <div class="col-md-5">
     <div class="form-group @if($errors->has('data_ativo')) has-error @endif">
       {!! Form::label('data_ativo', 'Data de Inativação') !!}
       {!! Form::date('data_ativo', $binomio->data_ativo, array('class'=>'form-control')) !!}
   ...
   <div class="form-group @if($errors->has('observacoes')) has-error @endif">
    {!! Form::label('observacoes', 'Motivo de Inativação') !!}
    {!! Form::text('observacoes', $binomio->observacoes, array('class'=>'form-control')) !!}
