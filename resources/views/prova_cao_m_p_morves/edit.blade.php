...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> ProvaCaoMPMorves / Editar #{{$prova_cao_m_p_morf->id}}</h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('prova_cao_m_p_morves.update', $prova_cao_m_p_morf->id) }}" method="POST">
                ...
                <div class="well well-sm">
                  ...
                  <?php }?>
                    <a class="btn btn-link pull-right" href="{{ route('prova_cao_m_p_morves.index') }}"><i class="glyphicon glyphicon-backward"></i>  Voltar</a>
                </div>
            </form>
