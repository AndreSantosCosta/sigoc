...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> ProvaCaoMPMorves / Edit #{{$prova_cao_m_p_morf->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('prova_cao_m_p_morves.update', $prova_cao_m_p_morf->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('idprovacao')) has-error @endif">
                    ...
                    <input type="text" id="idprovacao-field" name="idprovacao" class="form-control" value="{{ $prova_cao_m_p_morf->idprovacao }}"/>
                    ...
                    <input type="text" id="data_nascim-field" name="data_nascim" class="form-control" value="{{ $prova_cao_m_p_morf->data_nascim }}"/>
                    ...
                    <input type="text" id="peso-field" name="peso" class="form-control" value="{{ $prova_cao_m_p_morf->peso }}"/>
                       @if($errors->has("peso"))
                    ...
                    <input type="text" id="comprimento-field" name="comprimento" class="form-control" value="{{ $prova_cao_m_p_morf->comprimento }}"/>
                    ...
                    <input type="text" id="altgarrote-field" name="altgarrote" class="form-control" value="{{ $prova_cao_m_p_morf->altgarrote }}"/>
                    ...
                    <input type="text" id="altgarupa-field" name="altgarupa" class="form-control" value="{{ $prova_cao_m_p_morf->altgarupa }}"/>
                    ...
                    <textarea class="form-control" id="pelagem-field" rows="3" name="pelagem">{{ $prova_cao_m_p_morf->pelagem }}</textarea>
                    ...
                    <input type="text" id="perimetro-field" name="perimetro" class="form-control" value="{{ $prova_cao_m_p_morf->perimetro }}"/>
                    ...
                    <input type="text" id="orelhas-field" name="orelhas" class="form-control" value="{{ $prova_cao_m_p_morf->orelhas }}"/>
                    ...
                    <input type="text" id="distolhos-field" name="distolhos" class="form-control" value="{{ $prova_cao_m_p_morf->distolhos }}"/>
                    ...
                    <input type="text" id="distocciptrufa-field" name="distocciptrufa" class="form-control" value="{{ $prova_cao_m_p_morf->distocciptrufa }}"/>
                    ...
                    <input type="text" id="compchanfro-field" name="compchanfro" class="form-control" value="{{ $prova_cao_m_p_morf->compchanfro }}"/>
                    ...
                    <input type="text" id="diamchanfro-field" name="diamchanfro" class="form-control" value="{{ $prova_cao_m_p_morf->diamchanfro }}"/>
                    ...
                    <textarea class="form-control" id="observacoes-field" rows="3" name="observacoes">{{ $prova_cao_m_p_morf->observacoes }}</textarea>
                    ...
                    <textarea class="form-control" id="arquivo-field" rows="3" name="arquivo">{{ $prova_cao_m_p_morf->arquivo }}</textarea>
