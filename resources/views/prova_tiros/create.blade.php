...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-plus"></i> ProvaTiros / Create </h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('prova_tiros.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('prova_id')) has-error @endif">
                    ...
                    <input type="text" id="nota_final-field" name="nota_final" class="form-control" value="{{ old("nota_final") }}"/>
